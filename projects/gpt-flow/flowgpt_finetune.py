...
def get_config():
    ...
    C.system = CN()
    C.system.seed = 1028
    C.system.work_dir = './model/quanzhou/weekend'
...
if __name__ == '__main__':
    ...
    def batch_end_callback(trainer):
        ...
        if trainer.iter_num % 10 == 0:
            ...
            print("saving model")
            ckpt_path = os.path.join(config.system.work_dir, "model_finetuning" + str(trainer.iter_num + 1) + ".pt")
